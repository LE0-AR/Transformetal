	...
	<body>
		...
		<section>
			<div class="head">
				<h1><span>Metalmecánica para la </span><br>industria <span> Torre</span></h1>
			</div>
			...
			<section class="salones">
				<div class="salones-text">
					<h2>Resistencia y Precisión para Altura</h2>
					<p>
					...
					<br>
					<p>
						Desde torres arriostradas hasta accesorios y bases de cimentación, ofrecemos soluciones completas que cumplen con los estándares
						más exigentes. Confíe en Transformetal para desarrollar estructuras confiables y de calidad superior que impulsen sus proyectos
						hacia nuevas alturas.
					</p>
				</div>
				<div class="salones-image">
					<img src="../assets/img/anuncio/anuncio6.jpg" alt="Salones Equipados">
				</div>
			</section>
			<!-- Sección Principal -->
