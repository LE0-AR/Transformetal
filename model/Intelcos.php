	...
	<body>
		...
		<section>
			<div class="head">
				<h1><span>Metalmecánica para la </span><br>industria de las<span> Telcos e IT</span></h1>
			</div>
			...
			<section class="salones">
				<div class="salones-text">
					<h2>Telecomunicaciones e I.T</h2>
					<p>
						En el corazón de las telecomunicaciones y las tecnologías de la información, la metalmecánica
						desempeña un papel esencial al soportar y proteger la infraestructura que impulsa la conectividad
						global. Ofrecemos soluciones completas que abarcan desde gabinetes y racks para micro data centers
						hasta estructuras para ambientes indoor y outdoor, diseñadas para nodos de telecomunicaciones y salas IT.
					</p>
					<br>
					<p>
						Lorem, ipsum dolor sit amet consectetur adipisicing elit. In provident officiis modi iure! Fugit magnam
						laborum numquam, atque maiores velit natus qui. Dolorum iusto debitis, tempore maxime natus aliquid delectus?
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae labore natus, praesentium dicta tempora quos +
						aperiam? Quod fuga numquam expedita nesciunt et, cupiditate, itaque totam assumenda optio at voluptatibus maiores.
					</p>
				</div>
				<div class="salones-image">
					<img src="../assets/img/anuncio/Anuncio1Slider.png" alt="Salones Equipados">
				</div>
			</section>
			<!-- Sección Principal -->
			<section class="capacitaciones">
				...
				<div class="help-grid">
					<a href=" #" class="help-item">
						<img src="../assets/img/icon/subcategorias/gabinete_1.png" alt="Negocios">
						<p>Gabinetes</p>
					</a>
					<a href="" class="help-item">
						<img src="../assets/img/icon/subcategorias/racks.png" alt="Soluciones de crédito y finanzas">
						<p>Racks</p>
					</a>
					<a href="" class="help-item">
						<img src="../assets/img/icon/subcategorias/bandeja_1.png" alt="Equipos de infraestructura de comunicaciones críticas">
						<p>Bandejas</p>
					</a>
					<a href="" class="help-item">
						<img src="../assets/img/icon/subcategorias/riel.png" alt="Suministros de emergencia">
						<p>Riel</p>
					</a>
					<a href="" class="help-item">
						<img src="../assets/img/icon/subcategorias/escalerrilla_1.png" alt="Opciones de cotización acelerada">
						<p>Escalerrilla</p>
					</a>
					<a href="https://example.com/bomberos" class="help-item">
						<img src="../assets/img/icon/IT y Telecomunicaciones listo.png" alt="Bomberos">
						<p>Planta Externa</p>
					</a>
			...
			<section class="collections" id="priemra">


				<!-- Tarjeta 1 --
				<div class="collection-card">
					<img src="../assets/img/anuncio/anuncio2.png" alt="Growers Collections">
					<h3>For Anniversary</h3>
					<h2>Growers Collections</h2>
				...
				<!-- Tarjeta 2 --
				<div class="collection-card">
					<img src="../assets/img/Staff Transformetal.jpg" alt="Spring Collections">
					<h3>For Christmas</h3>
					<h2>Spring Collections</h2>
					<p>Contrary to popular belief, Lorem Ipsum.</p>
					<a href="#" class="arrow-link">➜</a>
				</div>
				...
				<!-- Tarjeta 3 --
				<div class="collection-card">
					<img src="../assets/img/gabinete/gabineteI 1.png" alt="Classic Collections">
					<h3>For Wedding</h3>
				...
				<!-- Tarjeta 4 
				<div class="collection-card">
					<img src="../assets/img/industrias/comerciosIndustrias.jpg" alt="Exotic Collections">
					<h3>For Birthday</h3>
					<h2>Exotic Collections</h2>
					<p>Contrary to popular belief, Lorem Ipsum.</p>
					<a href="#" class="arrow-link">➜</a>
				</div>
				-->
