	...
	<head>
		...
		<link rel="icon" type="image/png" href="assets/img/icon/Exhibición y Almacenes.pngassets/img/logo.png" />
	...
	<body>
		...
		<section>
			<div class="head">
				<h1><span>Metalmecánica para la </span><br>industria <span> Mobiliaria</span></h1>
			</div>
			...
			<section class="salones">
				<div class="salones-text">
					<h2>Innovación y Resistencia en Cada Proyecto</h2>
					<p>
						Transformetal desarrolla soluciones metálicas diseñadas para mejorar los espacios urbanos,
						combinando funcionalidad, estética y durabilidad. Ofrecemos productos como mobiliario urbano,
						estructuras metálicas y soluciones personalizadas que se integran de manera eficiente en el entorno, a
						portando modernidad y practicidad.
					</p>
					<br>
					<p>
						Con materiales de alta calidad y tecnología avanzada, nuestras creaciones son ideales para proyectos de infraestructura,
						transporte y espacios públicos. En Transformetal, trabajamos para construir ciudades más funcionales y sostenibles con
						soluciones innovadoras y de alto rendimiento.
					</p>
				</div>
				<div class="salones-image">
					<img src="../assets/img/anuncio/anuncio4.jpg" alt="Salones Equipados">
				</div>
			</section>
			<!-- Sección Principal -->
