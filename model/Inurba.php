	...
	<body>
		...
		<section>
			<div class="head">
				<h1><span>Metalmecánica para la </span><br>industria <span> Urbano</span></h1>
			</div>
			...
			<section class="salones">
				<div class="salones-text">
					<h2> Soluciones Sostenibles y Funcionales</h2>
					<p>
						En Transformetal, diseñamos y fabricamos productos metálicos que transforman el
						entorno urbano, aportando funcionalidad, resistencia y estilo. Desde mobiliario
						urbano hasta estructuras metálicas para espacios públicos e infraestructura, nuestras
						soluciones están hechas para soportar las demandas de la vida en la ciudad.
					</p>
					<br>
					<p>
						Con un enfoque en la durabilidad y la sostenibilidad, nuestros productos combinan tecnología
						avanzada y materiales de alta calidad para crear espacios urbanos más eficientes y estéticos.
						Transformetal, su aliado para construir un futuro urbano más moderno y funcional.
					</p>
				</div>
			...
			<section class="capacitaciones">
				...
				<div class="help-grid">
					<a href=" #" class="help-item">
						<img src="../assets/img/icon/subcategorias/subca/basurero_.png" alt="Basureros">
						<p>Basureros</p>
					</a>
					<a href="" class="help-item">
						<img src="../assets/img/icon/subcategorias/racks.png" alt="rack">
						<p>Racks</p>
					</a>
					<a href="" class="help-item">
						<img src="../assets/img/icon/subcategorias/bandeja_1.png" alt="Bancas">
						<p>Bancas</p>
					</a>
